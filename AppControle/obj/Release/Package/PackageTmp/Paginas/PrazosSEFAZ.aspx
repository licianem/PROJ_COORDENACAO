<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="PrazosSEFAZ.aspx.cs" Inherits="AppControle.Paginas.PrazosSEFAZ" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderHead" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <legend>Prazos SEFAZ <span style="font-size:10px !important;"> <asp:Label ID="lbData" runat="server" ></asp:Label></span></legend>
         ...
         <asp:GridView CssClass="GridResultado" ID="GridPropostas" runat="server"
            SkinID="SkinGrdSemPaginacaoComLinhas" AutoGenerateColumns="False">
                <Columns>
                    ...
                    <asp:BoundField DataField="ENVIO_PROPOSTA" HeaderText="Envio Proposta" />
